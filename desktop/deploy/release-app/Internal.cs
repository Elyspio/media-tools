...
using SwaggerMerge.ReleaseApp.json;
...
public class Internal
{
    ...
    public static readonly string ReleasesDir = Path.GetFullPath(Path.Combine(RootDir, "releases"))!;

    static string GetCurrentFileName([CallerFilePath] string fileName = null)
    {
        return fileName;
    }
