          ...
          <Box className={"Encoder__toolbar"}>
            ...
            >
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} size={"small"} fullWidth label="Manufacturer" />
                )}
              ...
              {manufacturer && (
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} size={"small"} fullWidth label="Encoder" />
                  )}
          ...
          {files.length > 0 ? (
            ...
            <Box className={"Encoder__empty"}>
              ...
              <Typography sx={{ color: "var(--text-muted)", fontSize: "0.8125rem" }}>
                Select files to begin encoding
              </Typography>
            </Box>
          )}
          ...
          {files.length > 0 && (
            <Box className={"Encoder__footer"}>
              ...
              >
                ...
                {convertSizeToHumanFormat(files.reduce((acc, f) => acc + f.file.size, 0))}
              </Typography>
              ...
              {format &&
                (encoding ? (
                  <Button
                    ...
                    variant="outlined"
                    startIcon={<Stop />}
                    onClick={() => actions.stopConvertMedia()}
                  >
                    Cancel
                  </Button>
                ) : (
