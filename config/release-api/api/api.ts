...
export const AppsApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 * @throws {RequiredError}
		 */
		getLatestVersion: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			// verify required parameter 'name' is not null or undefined
			assertParamExists("getLatestVersion", "name", name);
		 ...
		 * @throws {RequiredError}
		 */
		getLatestVersion_1: async (name: string, arch: AppArch, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
			// verify required parameter 'name' is not null or undefined
			assertParamExists("getLatestVersion_1", "name", name);
			// verify required parameter 'arch' is not null or undefined
			assertParamExists("getLatestVersion_1", "arch", arch);
			const localVarPath = `/api/apps/{name}/{arch}/version`
				.replace(`{${"name"}}`, encodeURIComponent(String(name)))
				.replace(`{${"arch"}}`, encodeURIComponent(String(arch)));
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AppsApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async getLatestVersion(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.getLatestVersion(name, options);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
		},
		/**
		 *
		 ...
		 * @throws {RequiredError}
		 */
		async getLatestVersion_1(name: string, arch: AppArch, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppVersion>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getLatestVersion_1(name, arch, options);
			return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
		},
	};
};
...
export const AppsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		getLatestVersion(name: string, options?: any): AxiosPromise<{ [key: string]: Array<AppVersion> }> {
			return localVarFp.getLatestVersion(name, options).then(request => request(axios, basePath));
		},
		/**
		 *
		 * @param {string} name
		 ...
		 * @throws {RequiredError}
		 */
		getLatestVersion_1(name: string, arch: AppArch, options?: any): AxiosPromise<AppVersion> {
			return localVarFp.getLatestVersion_1(name, arch, options).then(request => request(axios, basePath));
		},
	};
};
...
export class AppsApi extends BaseAPI {
	 ...
	 * @memberof AppsApi
	 */
	public getLatestVersion(name: string, options?: AxiosRequestConfig) {
		return AppsApiFp(this.configuration)
	 ...
	 * @memberof AppsApi
	 */
	public getLatestVersion_1(name: string, arch: AppArch, options?: AxiosRequestConfig) {
		return AppsApiFp(this.configuration)
			.getLatestVersion_1(name, arch, options)
			.then(request => request(this.axios, this.basePath));
	}
}
