...
export const AppsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getAllMetadata: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/apps/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        getLatestVersions: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/apps/{name}/version`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AppsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getLatestArchSpecificVersion(name: string, arch: AppArch, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppVersion>> {
         ...
         * @throws {RequiredError}
         */
        async getLatestVersions(name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: Array<AppVersion>; }>> {
...
export class AppsApi extends BaseAPI {
    ...
    public _delete(name: string, version: string, arch: AppArch, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration)._delete(name, version, arch, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public add(addApp?: AddApp, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration).add(addApp, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllMetadata(name: string, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration).getAllMetadata(name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBinary(name: string, version: string, arch: AppArch, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration).getBinary(name, version, arch, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getLatestArchSpecificVersion(name: string, arch: AppArch, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration).getLatestArchSpecificVersion(name, arch, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getLatestVersions(name: string, options?: AxiosRequestConfig) {
        return AppsApiFp(this.configuration).getLatestVersions(name, options).then((request) => request(this.axios, this.basePath));
    }
}
