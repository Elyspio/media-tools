...
export class Projects extends Component<object, State> {
						...
						<Box className="options row">
							...
							<div className={"option"}>
								...
								{github && (
									<FormControlLabel
										control={
											<Checkbox checked={template} color={"default"} onChange={(e) => this.handleChange("template", e.target.checked)} name="Template" />
										}
										labelPlacement={"start"}
										label="Template"
										className={"switch"}
