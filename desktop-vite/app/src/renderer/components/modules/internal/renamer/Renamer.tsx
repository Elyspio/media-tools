...
import { RenamerField, setRenamerField } from "../../../../store/module/renamer/renamer.action";
import { createSelector } from "reselect";
import { refreshRenamerExample, runRename, runReplaceChars, setRenamerFiles } from "../../../../store/module/renamer/renamer.async.actions";
...
const RenamerComponent = () => {
	...
	const options = useMemo(
		...
		[canReplaceChars, example, files.length, max, min, newName, rename, replaceChars, updateField]
	);
