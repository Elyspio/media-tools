...
container.bind<GithubService>(DependencyInjectionKeys.projects.github).toConstantValue(new GithubService());
container.bind<FeatureService>(DependencyInjectionKeys.projects.feature).toConstantValue(new FeatureService());
container.bind<DockerService>(DependencyInjectionKeys.projects.docker).toConstantValue(new DockerService());
